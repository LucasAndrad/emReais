...
coins = Coin.create([
    ...
    { name: 'Pataca', code: 'MOP', symbol: 'MOP$', country: 'Macau',
      ...
      story: 'Em 1894 a a nomenclatura Pataca é introduzida em Macau, a pataca correspondia ao dolár mexicano e tinha um valor de 1 pataca = 450 reais, essa medida tinha como objetivo substituir o real português. O nome pataca se deve ao fato dos portugueses chamarem o dólar mexicano de pataca mexicana. Mesmo com essa medida ainda no século 19 existiam diversas moedas circulando em Macau (dólares mexicano e britânico). Finalmente em 1901 foi decidido que Macau deveria ter apenas uma única moeda em circulação dentro do país, o Banco Nacional Ultramarinho (fundado em Lisboa) ficou com os direitos para a emissão de moedas/notas denominadas Patacas. No ano de 1906 as primeiras notas de 1, 5, 50 e 100 são inauguradas no mercado e as demais moedas foram proibidas. Nos anos 50 a moeda oscilou ora de acordo com o valor da prata e ora de acordo com o valor do ouro. Somente em 1980 o Instituto Emissor de Macau (criado pelo governo de Macau) conseguiu o direito de emitir as patacas. O Banco Nacional Ultramarinho se tornou agente do IEM e continuou a emitir as patacas até o ano de 1995, quando o a lisença para emissão das patacas é transferida para a Autoridade Monetária de Macau e o ramo de Macau do banco da China se torna o segundo emissor oficial das patacas.' },
    ...
    { name: 'Won', code: 'KRW', symbol: '₩', country: 'Coréia do Sul',
      ...
      story: 'A moeda sul Coreana Won é dividida em 100 jeon que curiosamente não utilizado em transações no dia a dia dos sul-coreanos. O Banco da Coreai é o atual emissor do Won e fica sediado em Seul, capital do país. A história dessa moeda começa pouco depois da era colonial, quando o país ainda adotava o Iene japonês como moeda oficial, depois de segunda guerra mundial (1945) o país dividido em sul e norte possuia duas moedas chamadas won, Won do Sul e Won do Norte, substituindo de vez o Iene japonês. O Won do Sul foi inicialmente vinculado ao dólar americano, entretanto a moeda sempre esteve bem desvalorizada, em 1945 15 wons = 1 dólar. Apenas 6 anos depois, em 1951 6000 wons = 1 dólar' },

    { name: 'Iene', code: 'JPY', symbol: '¥', country: 'Japão',
      url_name: 'japao-iene', 
      flag: 'https://lipis.github.io/flag-icon-css/flags/4x3/jp.svg', 
      story: 'O Iene é a moeda oficial do Japão e também a terceira moeda mais comercializada no mundo, é a reserva financeita mais usada no mundo, somente atrás do dólar americano, do euro e da libra esterlina. Começamos com a história do Iene a partir da segunda guerra mundial, em Abril de 1949 durante a ocupação americano no japão (período pós guerra) o preço do Iene foi fixado em ¥ 360 = $ 1. A ideia de fazer com o que a moeda japonesa fosse subvalorizada (baixo valor de mercado em relação as outras moedas) teve seu primeiro reflexo em 1971 quando o país saiu do saldo negativo para um saldo positivo de 5,8 bilhões de dólares, mas como? O país que tem como foco a exportação desvalorizou a própria moeda para conseguir exportar com preços mais atrativos em relação aos seus concorrentes em contra mão a importação fica mais cara para os japoneses entretanto a conta final resultou em um saldo positivo para o país. Nos anos 80 o governo e os empresários japoneses incentivaram fortemente na desvalorização da moeda pois ambos tinham medo que a valorização imposta pelo mercado extrangeiro afetasse as exportação do país. Os esforços duraram até 1985 quando as autoridades financeiras de grandes economias assinaram o Acordo de Plaza que rotulavo o dólar americano como sobrevalorizado e o Iene como subvalorizado, como solução para esse problema as pressões internacionais conseguiram elevar o valor do Iene e o mesmo atingiu seu pico em 1995 quando ¥ 80 = 1 $. Nesse ano a economia do Japão era quase do mesmo tamanho dos EUA. Depois da crise de 2008 as principais moedas do mundo entraram em desvalorização em relação ao Iene fato que afeta negativamente as exportações do país. Por esse motivo até 2013 o governo japonês tem dedicado seus esforços para desvalorizar o Iene novamente.' },
